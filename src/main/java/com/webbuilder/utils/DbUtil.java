...
public class DbUtil {
	...
	public static void exportData(Writer writer, ResultSet rs) throws Exception {
		ResultSetMetaData meta = rs.getMetaData();
		int i, j = meta.getColumnCount(), types[] = new int[j];
	...
	public static Object getObject(CallableStatement st, int index, int type)
		...
		case Types.VARCHAR:
		case Types.NVARCHAR:
			obj = st.getString(index);
			break;
		case Types.INTEGER:
			obj = st.getInt(index);
			break;
		case Types.TINYINT:
			obj = st.getByte(index);
			break;
		case Types.SMALLINT:
			obj = st.getShort(index);
			break;
		case Types.BIGINT:
			obj = st.getLong(index);
			break;
		case Types.REAL:
		case Types.FLOAT:
			obj = st.getFloat(index);
			break;
		case Types.DOUBLE:
			obj = st.getDouble(index);
			break;
		case Types.DECIMAL:
		case Types.NUMERIC:
			obj = st.getBigDecimal(index);
			break;
		case Types.TIMESTAMP:
		case Types.DATE:
			obj = st.getTimestamp(index);
			break;
		case Types.TIME:
			obj = st.getTime(index);
			break;
		case Types.BOOLEAN:
		case Types.BIT:
			obj = st.getBoolean(index);
			break;
	 ...
	 * @throws Exception
	 */
	public static List extractData(ResultSet rs)throws Exception {
